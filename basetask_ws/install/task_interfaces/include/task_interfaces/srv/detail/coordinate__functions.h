...
#ifndef TASK_INTERFACES__SRV__DETAIL__COORDINATE__FUNCTIONS_H_
#define TASK_INTERFACES__SRV__DETAIL__COORDINATE__FUNCTIONS_H_
...
/// Initialize srv/Coordinate message.
/**
...
/// Finalize srv/Coordinate message.
/**
...
/// Create srv/Coordinate message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_interfaces__srv__Coordinate_Request__init().
...
/// Destroy srv/Coordinate message.
/**
 * It calls
 * task_interfaces__srv__Coordinate_Request__fini()
...
/// Check for srv/Coordinate message equality.
/**
...
/// Initialize array of srv/Coordinate messages.
/**
...
/// Finalize array of srv/Coordinate messages.
/**
 * It calls
 * task_interfaces__srv__Coordinate_Request__fini()
...
/// Create array of srv/Coordinate messages.
/**
 * It allocates the memory for the array and calls
 * task_interfaces__srv__Coordinate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Coordinate messages.
/**
 * It calls
 * task_interfaces__srv__Coordinate_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Coordinate message array equality.
/**
...
/// Copy an array of srv/Coordinate messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_interfaces__srv__Coordinate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_interfaces
...
/**
 * It calls
 * task_interfaces__srv__Coordinate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task_interfaces
...
/**
 * It allocates the memory for the array and calls
 * task_interfaces__srv__Coordinate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_interfaces
...
/**
 * It calls
 * task_interfaces__srv__Coordinate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TASK_INTERFACES__SRV__DETAIL__COORDINATE__FUNCTIONS_H_
